...
public class factsheetslistpage_Test extends BaseClass {
	...
	@Test
    public void verifySubjectList() {
    	driver.get(pageURL);
		fslp = new FactSheetsListPage(driver, logger);
    	List<String> allElementsAsString  = fslp.getSubjectListing();
    	Assert.assertTrue(EXP_FACTSHEETLISTS_ON_FACTSHEETSLISTPAGE.equals(allElementsAsString));
		logger.log(LogStatus.PASS,
				"Verify that all the nine subject lists are displayed | Actual Result: "
						+ allElementsAsString);
}
}
