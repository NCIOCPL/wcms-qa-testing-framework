...
public class SitewideSearch_Test extends BaseClass {
	...
	// Verify the Search result page Title and H1 title is correct
	@Test(dataProvider = "Search", groups = { "Smoke" })
	public void verifySearchResultsPageTitle(String keyword) {
		...
		logger.log(LogStatus.PASS, "Verify that Page Title and H1 title of Search Results page is correct");
	}
