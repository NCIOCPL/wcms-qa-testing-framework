...
public class SitewideSearch_Test extends BaseClass {
	...
	// Verify that the top Results For section is displayed correctly
	@Test(dataProvider = "Search", groups = { "Smoke" })
	public void verifySitewideSearchTopResultsFor(String keyword) {

		System.out.println("Search Keyword: " + keyword);
		search.search(keyword);

		// Verify that the Results For Text contains search keyword
	...
	// Verify that the bottom Results For section is displayed correctly
	@Test(dataProvider = "Search", groups = { "Smoke" })
	public void verifySitewideSearchBottomResultsFor(String keyword) {

		System.out.println("Search Keyword: " + keyword);
		search.search(keyword);

		// Verify that the Results For Text at bottom of page is displayed
		// correctly
		WebElement bottomResultforText = driver.findElement(By.xpath("//*[@id='ctl34_lblBottomResultsXofY']"));
		System.out.println("Bottom Result for Text Value ***********: " + bottomResultforText.getText());
		Assert.assertTrue(bottomResultforText.getText().contains("Results 1\u201310 of"));
	...
	/*
	 * @Test(dataProvider = "Search", groups = { "Smoke" }) public void
	 * verifySitewideSearch(String keyword) {
	 * 
	 * System.out.println("Search Keyword: " + keyword); search.search(keyword);
	 * 
	 * // Verify Search Results page common validation
	 * verifySearchResultsPage();
	 * 
	 * //Verify that the Result Text contains search keyword WebElement ele =
	 * driver.findElement(By.xpath("//h3[@id='ui-id-2']"));
	 * System.out.println("Element Value ***********: " + ele.getText());
	 * Assert.assertTrue(ele.getText().equals("Results for: " + keyword));
	 * 
	 * //Verify that the Top Search Result Text contains search keyword
	 * WebElement topResultText = driver.findElement(By.xpath("(//h4)[1]"));
	 * System.out.println("Top Result Text Value ***********: " +
	 * topResultText.getText());
	 * Assert.assertTrue(topResultText.getText().contains("Results 1\u201310 of"
	 * )); Assert.assertTrue(topResultText.getText().contains("for: " +
	 * keyword));
	 * 
	 * //Verify that the bottom Search Result Text contains search keyword
	 * WebElement bottomResultText = driver.findElement(By.xpath("(//h4)[2]"));
	 * System.out.println("Bottom Result Text Value ***********: " +
	 * bottomResultText.getText());
	 * Assert.assertTrue(bottomResultText.getText().
	 * contains("results found for: " + keyword));
	 * 
	 ...
	 * 
	 * @Test(groups = { "Smoke" }) public void verifyEmptySitewideSearch() {
	 * 
	 * String keyword = "";
	 * 
	 * System.out.println("Search Keyword: Empty"); search.search(keyword);
	 * 
	 * // Verify Search Results page common validation
	 * verifySearchResultsPage();
	 * 
	 ...
	 * WebElement topResultText = driver.findElement(By.xpath("(//h4)[1]"));
	 * System.out.println("Top Result Text Value ***********: " +
	 * topResultText.getText()); Assert.assertTrue(topResultText.getText().
	 * contains("Results 0\u20130 of 0 for:"));
	 * 
	 * //Verify that the error message is displayed for empty search WebElement
	 * errorMsg =
	 * driver.findElement(By.xpath("(//h4)[1]/following-sibling::div[1]"));
	 * System.out.println("Error Message for empty search ***********: " +
	 * errorMsg.getText()); Assert.assertTrue(errorMsg.getText().
	 * contains("Please enter a search phrase."));
	 * 
	 * //Verify that the bottom Search Result Text contains search keyword
	 * WebElement bottomResultText = driver.findElement(By.xpath("(//h4)[2]"));
	 * System.out.println("Bottom Result Text Value ***********: " +
	 ...
	 * 
	 * @Test(dataProvider = "SearchWithinSearch", groups = { "Smoke" }) public
	 * void verifySearchWithinSearch(String keyword1, String keyword2) {
	 * 
	 * // Perform Search search.SearchWithinSearch(keyword1, keyword2);
	 * System.out.println("SearchWithinSearch function executed");
	 * 
	 * // Verify Search Results page common validation
	 * verifySearchResultsPage();
	 * 
	 * //Verify that the Result Text contains search keywords WebElement ele =
	 * driver.findElement(By.xpath("//h3[@id='ui-id-2']"));
	 * System.out.println("Element Value ***********: " + ele.getText());
	 * Assert.assertTrue(ele.getText().equals("Results for: " + keyword1 + " : "
	 * + keyword2));
	 * 
	 * //Verify that the Top Search Result Text contains search keywords
	 * WebElement topResultText = driver.findElement(By.xpath("(//h4)[1]"));
	 * System.out.println("Top Result Text Value ***********: " +
	 * topResultText.getText()); // "\u2013" is an endash
	 * Assert.assertTrue(topResultText.getText().contains("Results 1\u201310 of"
	 * )); Assert.assertTrue(topResultText.getText().contains("for: " + keyword1
	 * + " : " + keyword2));
	 * 
	 * //Verify that the bottom Search Result Text contains search keyword
	 * WebElement bottomResultText = driver.findElement(By.xpath("(//h4)[2]"));
	 ...
	 * bottomResultText.getText());
	 * Assert.assertTrue(bottomResultText.getText().
	 * contains("results found for: " + keyword1 + " : " + keyword2));
	 * 
	 * logger.log(LogStatus.PASS,
