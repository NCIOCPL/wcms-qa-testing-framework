...
public class R4RResultsPageLoad_Test extends AnalyticsTestLoadBase {

	private final String PATH = "/research/resources/search";
	...
	public void testR4RPageLoad() {
		...
		System.out.println("Page type: R4R Results Page");
	...
	private void doCommonClassAssertions(Beacon beacon) {
		...
		Assert.assertEquals(beacon.props.get(10),
				"Resources for Researchers: Search Results - National Cancer Institute", "prop10");
